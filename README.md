...
El workflow está definido en [`.github/workflows/javadoc.yml`](.github/workflows/javadoc.yml) y se encarga de generar y publicar la documentación de forma automática.
