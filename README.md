...
| 6 | `${{ secrets.GITHUB_TOKEN }}` | GITHUB_TOKEN es un token de autenticación o "contraseña temporal" automático que GitHub crea para cada workflow de GitHub Actions. Sirve para que las acciones dentro del workflow puedan interactuar con el repositorio de forma segura |
